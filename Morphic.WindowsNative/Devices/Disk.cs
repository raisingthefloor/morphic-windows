...
public class Disk
{
   ...
   public static async Task<MorphicResult<List<Disk>, GetDisksError>> GetAllDisksAsync()
   {
       ...
       var allDiskDevicesResult = Morphic.WindowsNative.Devices.Device.GetDevicesForClassGuid(ExtendedPInvoke.GUID_DEVINTERFACE_DISK);
   ...
   public async Task<MorphicResult<IEnumerable<Drive>, Drive.GetDrivesError>> GetDrivesAsync()
   {
       ...
       var getAllDrivesResult = await Morphic.WindowsNative.Devices.Drive.GetAllDrivesAsync();
