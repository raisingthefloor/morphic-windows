...
internal class TrayButton : IDisposable
{
    ...
    private class TrayButtonNativeWindow : IDisposable
    {
        ...
        private Microsoft.UI.Dispatching.DispatcherQueueTimer? _trayButtonPositionCheckupTimer = null;
        ...
        public void Dispose()
        {
            ...
            _trayButtonPositionCheckupTimer?.Stop();
        ...
        private void TrayButtonPositionCheckup(Microsoft.UI.Dispatching.DispatcherQueueTimer sender, object args)
        {
        ...
        private (Windows.Win32.Foundation.RECT? currentRect, Windows.Win32.Foundation.RECT? changeToRect, Morphic.Controls.Orientation orientation)? CalculateCurrentAndTargetRectOfTrayButton()
        {
            ...
            if (taskbarOrientation == Morphic.Controls.Orientation.Horizontal)
            {
                ...
                if (new Windows.UI.ViewManagement.AccessibilitySettings().HighContrast == true)
                {
                    trayButtonHeight -= 1;
                }
                //
