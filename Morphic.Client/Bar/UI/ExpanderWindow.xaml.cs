...
namespace Morphic.Client.Bar.UI
{
    ...
    public partial class ExpanderWindow : Window
    {
            ...
            : this()
        {
            ...
            AppFocus.Current.MouseEnter += (sender, args) => this.IsWanted = true;
            AppFocus.Current.MouseLeave += (sender, args) => this.IsWanted = AppFocus.Current.IsActive || this.IsExpanded;
            AppFocus.Current.Activated += (sender, args) => this.IsWanted = true;
            AppFocus.Current.Deactivated += (sender, args) => this.IsWanted = this.IsExpanded;
