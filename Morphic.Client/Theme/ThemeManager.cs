...
namespace Morphic.Client.Theme;
...
internal class ThemeManager : IDisposable
{
    ...
    public ThemeManager()
    {
        ...
        var currentAppTheme = Morphic.Client.Theme.ThemeManager.GetCurrentAppTheme();
        ...
        Morphic.Client.UI.ThemeColors.ThemeColorsChanged += this.ThemeColors_ThemeColorsChanged;
            ...
            case ThemeOption.Light:
                {
                    ...
                    var backgroundColor = Morphic.Client.UI.ThemeColors.GetBackgroundColor();
                    ...
                    //
                    var foregroundColor = Morphic.Client.UI.ThemeColors.GetForegroundColor();
    ...
    private void UpdateTheme(bool highContrastIsOn, bool isDarkColorTheme)
    {
        if (highContrastIsOn == true)
        {
            if (isDarkColorTheme == true)
            {
                this.SetTheme(Morphic.Client.Theme.ThemeOption.HighContrastBlack);
            }
            else
            {
                this.SetTheme(Morphic.Client.Theme.ThemeOption.HighContrastWhite);
            }
        }
        else
        {
            if (isDarkColorTheme == true)
            {
                this.SetTheme(Morphic.Client.Theme.ThemeOption.Dark);
            }
            else
            {
                this.SetTheme(Morphic.Client.Theme.ThemeOption.Light);
            }
        }
    }
