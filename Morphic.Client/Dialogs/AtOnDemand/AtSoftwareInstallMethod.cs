...
public record AtSoftwareInstallMethod : MorphicAssociatedValueEnum<AtSoftwareInstallMethod.Values>
{
    // enum members
    public enum Values
    {
    ...
    // associated values
    public string? PathToMsi { get; private set; }

    // verbatim required constructor implementation for MorphicAssociatedValueEnums
    private AtSoftwareInstallMethod(Values value) : base(value) { }
}
