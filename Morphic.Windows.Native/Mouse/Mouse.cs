...
namespace Morphic.Windows.Native.Mouse
{
    public class Mouse
    {
        ...
        public static MorphicResult<MorphicUnit, Win32ApiError> MoveCursorToCenterOfDisplay(Morphic.Windows.Native.Display.Display display)
        {
