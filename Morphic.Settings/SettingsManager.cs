...
namespace Morphic.Settings
{
    ...
    public class SettingsManager: IServiceProvider
    {
        ...
        public static class Keys
        {
            ...
            public static Preferences.Key WindowsDisplayLightAppsThemeEnabled = new Preferences.Key("com.microsoft.windows.display", "lighttheme-apps.enabled");
            public static Preferences.Key WindowsDisplayLightWindowsThemeEnabled = new Preferences.Key("com.microsoft.windows.display", "lighttheme-windows.enabled");
